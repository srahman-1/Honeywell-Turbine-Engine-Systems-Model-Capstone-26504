...
print("Specific Gas Constant: ", "\nSpeed of Sound:", "\nMach Number:",
      ...
      "\nCorrected total mass flow values (total, fan, core):", "\nCorrected fan mass flow values:",
      "\nCorrected core mass flow values ",
      "\nThrust based on geometry mass flow:", "\nThrust based on corrected mass flow:",
      "\nSplitter Radius:", "\nArea of core:", "\nArea at station 13 (inlet to bypass duct):",
      "\nVelocity based on geometry mass flow:", "\nVelocity based on corrected mass flow:",
      "\nVelocity at Station 19, Bypass Nozzle Exit:",
      "\nArea of Bypass Nozzle Exit (geometry mass flow):", "\nArea of Bypass Nozzle Exit (corrected mass flow):")
"""
